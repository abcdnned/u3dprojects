...
namespace TY {
    ...
    public class PhysicsModule : Module {
        ...
        private void InitializeStabilizerJoint() {
            ...
            Debug.Log(this.GetType().Name + " initialize stabilizer joint ");

            //init joint drive
            _stabilizerJointDrive = (JointDriveConfig)new JointDrive {
        ...
        private void FixedUpdate() {
            ...
            switch (_balanceMode) {
                case BALANCE_MODE.UPRIGHT_TORQUE:
                    ...
                    Debug.Log(this.GetType().Name + " UPRIGHT_TORQUE ");
                    break;
                ...
                case BALANCE_MODE.FREEZE_ROTATIONS:
                    ...
                    Debug.Log(this.GetType().Name + " FREEZE_ROTATIONS ");
                    break;
                ...
                case BALANCE_MODE.STABILIZER_JOINT:
                    ...
                    Debug.Log(this.GetType().Name + " STABILIZER_JOINT ");
                    break;
                ...
                case BALANCE_MODE.MANUAL_TORQUE:
                    ...
                    Debug.Log(this.GetType().Name + "MANUAL_TORQUE");
                    break;
